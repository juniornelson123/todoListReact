	...
	render(){
		return(
			<div>
				...
				<TodoList handleRemove={this.handleRemove} handlePendent={this.handlePendent} handleDone={this.handleDone} handleMarkFinish={this.handlerRemove} handleMarkPendent={this.handlerMarkPendent}/>
			</div>
		)
	}
}